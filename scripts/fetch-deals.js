...
// 自身の新しいCloudflare Pagesドメイン名に変更してください
const DOMAIN = 'https://steam-deals-site.pages.dev'; 

// CheapShark API: Steam(storeID=1)のセール中・最安値圏データを一括取得
const API_URL = 'https://www.cheapshark.com/api/1.0/deals?storeID=1&upperPrice=50&onSale=1&sortBy=Price&desc=0';
  ...
  try {
    ...
    const items = deals.slice(0, 50).map(deal => {
      ...
      return {
        ...
        // アフィリエイト提携通過前はCheapShark経由直リンク、承認後はアフィリID付きリンクに差し替え
